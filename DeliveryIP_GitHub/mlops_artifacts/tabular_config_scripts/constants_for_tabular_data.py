...
SCRIPTS = {
    ## With aml_v1.ipynb
#    'SOURCE_DIR': '../',
#    '001': 'pipeline_for_tabular_data/src/dataprep.py',
#    '002': 'pipeline_for_tabular_data/src/train_and_score.py',
#    '003': 'pipeline_for_tabular_data/src/model_management.py'
    ## With utils_provision.py
    'SOURCE_DIR': './',
